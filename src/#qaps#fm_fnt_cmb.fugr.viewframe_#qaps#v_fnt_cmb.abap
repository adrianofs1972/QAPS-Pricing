*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/QAPS/V_FNT_CMB
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/QAPS/V_FNT_CMB     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/QAPS/V_FNT_CMB'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /QAPS/V_FNT_CMB_EXTRACT
TOTAL = /QAPS/V_FNT_CMB_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_FNT_CMB'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/QAPS/V_FNT_CMB-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_FNT_CMB_EXTRACT
TOTAL = /QAPS/V_FNT_CMB_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/QAPS/V_FNT_CMB-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/QAPS/V_FNT_CMB'
...
TOTAL = /QAPS/V_FNT_CMB_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/QAPS/V_FNT_CMB-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/QAPS/V_FNT_CMB-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_FNT_CMB'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/QAPS/V_FNT_CMB-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_FNT_CMB_EXTRACT
TOTAL = /QAPS/V_FNT_CMB_TOTAL

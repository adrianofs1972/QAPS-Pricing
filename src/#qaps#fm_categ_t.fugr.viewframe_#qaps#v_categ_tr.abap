*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/QAPS/V_CATEG_TR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/QAPS/V_CATEG_TR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/QAPS/V_CATEG_TR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /QAPS/V_CATEG_TR_EXTRACT
TOTAL = /QAPS/V_CATEG_TR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_CATEG_TR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/QAPS/V_CATEG_TR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_CATEG_TR_EXTRACT
TOTAL = /QAPS/V_CATEG_TR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/QAPS/V_CATEG_TR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/QAPS/V_CATEG_TR'
...
TOTAL = /QAPS/V_CATEG_TR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/QAPS/V_CATEG_TR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/QAPS/V_CATEG_TR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_CATEG_TR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/QAPS/V_CATEG_TR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_CATEG_TR_EXTRACT
TOTAL = /QAPS/V_CATEG_TR_TOTAL

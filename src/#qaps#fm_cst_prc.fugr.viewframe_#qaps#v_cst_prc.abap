*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/QAPS/V_CST_PRC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/QAPS/V_CST_PRC     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/QAPS/V_CST_PRC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /QAPS/V_CST_PRC_EXTRACT
TOTAL = /QAPS/V_CST_PRC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_CST_PRC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/QAPS/V_CST_PRC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_CST_PRC_EXTRACT
TOTAL = /QAPS/V_CST_PRC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/QAPS/V_CST_PRC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/QAPS/V_CST_PRC'
...
TOTAL = /QAPS/V_CST_PRC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/QAPS/V_CST_PRC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/QAPS/V_CST_PRC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_CST_PRC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/QAPS/V_CST_PRC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_CST_PRC_EXTRACT
TOTAL = /QAPS/V_CST_PRC_TOTAL

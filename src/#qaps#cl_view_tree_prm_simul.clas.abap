class /QAPS/CL_VIEW_TREE_PRM_SIMUL definition
  public
...
CLASS /QAPS/CL_VIEW_TREE_PRM_SIMUL IMPLEMENTATION.


  METHOD add_child_node.

    FIELD-SYMBOLS <fs_line> TYPE /qaps/s_prm_hdr."/qaps/v_mat_hdr.
  ...
  METHOD add_child_node_destino.
    ...
    FIELD-SYMBOLS <fs_line> TYPE /qaps/s_prm_hdr.
    ...
    APPEND VALUE ts_line_key( key     = lv_nodekey
                              ...
                              guid = <fs_line>-id_premissa ) TO mt_nodes.
  ...
  METHOD add_child_node_tipo.
    ...
    FIELD-SYMBOLS <fs_line> TYPE /qaps/s_prm_hdr."/qaps/s_matriz_header./qaps/s_matriz_header.
    DATA: lv_icon          TYPE tv_image,
          lv_icon_expanded TYPE tv_image.
...
*         others                     = 6
  ...
  METHOD update.
    ...
    DATA lv_nodekey TYPE tm_nodekey.
    FIELD-SYMBOLS: <ft>           TYPE /qaps/t_premissa_header,
                   <fs_simulacao> TYPE /qaps/s_simulacao.
    ...
    CHECK NOT ir_expanded IS INITIAL.

    ASSIGN ir_expanded->* TO <fs_simulacao>.
    DATA(lv_id) = |{ <fs_simulacao>-id_simulacao ALPHA = OUT }|.
    lv_nodekey = |SIM#{ lv_id }|.

    mo_tree->expand_node(
      EXPORTING
        node_key            = lv_nodekey    " Node key

class /QAPS/CL_VIEW_GRP_PRODUTO_HDR definition
  public
...
CLASS /QAPS/CL_VIEW_GRP_PRODUTO_HDR IMPLEMENTATION.


  METHOD MERGE_DATA_TO_HTML.

    FIELD-SYMBOLS <fs> type /qaps/s_grupo_produto.
    ...
    lv_line = `<tr><td>Grupo de Produto:</td><td>` && <fs>-descricao && `</td></tr>`.
    add_to_html lv_line.

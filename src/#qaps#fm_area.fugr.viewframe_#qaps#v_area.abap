*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/QAPS/V_AREA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/QAPS/V_AREA        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/QAPS/V_AREA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /QAPS/V_AREA_EXTRACT
TOTAL = /QAPS/V_AREA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/QAPS/V_AREA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/QAPS/V_AREA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /QAPS/V_AREA_EXTRACT
TOTAL = /QAPS/V_AREA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/QAPS/V_AREA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/QAPS/V_AREA'
...
TOTAL = /QAPS/V_AREA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/QAPS/V_AREA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/QAPS/V_AREA-UPD_FLAG NE SPACE.

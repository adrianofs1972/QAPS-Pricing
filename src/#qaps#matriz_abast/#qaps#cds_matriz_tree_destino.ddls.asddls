@AbapCatalog.sqlViewName: '/QAPS/V_MTZ_DEST'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Matriz de Abastecimento - Destinos'
define view /qaps/cds_matriz_tree_destino 
as
select distinct from /qaps/cds_matriz_tree_base as destino

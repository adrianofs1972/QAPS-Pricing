@AbapCatalog.sqlViewName: '/QAPS/V_PR_DS_BS'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Premissa - Destinos - Base'
define view /qaps/cds_premissa_tree_base 
...
inner join /qaps/cds_ponto as ponto_centro on centro.id_centro = ponto_centro.id_externo
{               
        centro.mandt,        
        ponto.id_ponto,
        centro.id_grp_planta as id,
        'G' as tipo,
        ponto_centro.id_ponto as id_ponto_centro,

...
FORM f_ok .
  ...
  IF gs_data-id_modal IS INITIAL.
    MESSAGE 'Modal é um campo obrigatório' TYPE 'S' DISPLAY LIKE 'E'.
    RETURN.
  ENDIF.

*  IF gs_data-tempo_deslocamento IS INITIAL.
*    MESSAGE 'Temp Médio de Deslocamento é um campo obrigatório' TYPE 'S' DISPLAY LIKE 'E'.
*    RETURN.
*  ENDIF.
*
*  IF gs_data-distancia IS INITIAL.
*    MESSAGE 'Distância é um campo obrigatório' TYPE 'S' DISPLAY LIKE 'E'.
*    RETURN.
*  ENDIF.
